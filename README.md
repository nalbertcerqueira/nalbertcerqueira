...
>
    ...
    <desc id="descId">
        Total Stars Earned: 0, Total Commits in 2022 : 0, Total PRs: 0, Total Issues: 0, Contributed
        to (last year): 0
    </desc>
    <style>
        .header {
        ...
        <linearGradient id="gradient" gradientTransform="rotate(45)" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stop-color="#141414">
                <animate
                    ...
                    values="#141414;#202020;#1b4b25;141414"
                    dur="4s"
            ...
            <stop offset="50%" stop-color="#202020">
                <animate
                    attributeName="stop-color"
                    values="#202020;#1b4b25;#141414;202020"
                    dur="4s"
                    repeatCount="indefinite"
                />
            </stop>
            ...
            <stop offset="100%" stop-color="#1b4b25">
                <animate
                    attributeName="stop-color"
                    values="#1b4b25;#141414;#202020;1b4b25"
                    dur="4s"
                    repeatCount="indefinite"
                />
            </stop>
    ...
    <g data-testid="card-title" transform="translate(25, 35)">
        <g transform="translate(0, 0)">
            <text x="0" y="0" class="header" data-testid="header">
                Nalbert Cerqueira's GitHub Stats
            </text>
        </g>
    </g>
