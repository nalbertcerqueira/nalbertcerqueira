...
<svg xmlns="http://www.w3.org/2000/svg" width="495" height="195" viewBox="0 0 495 195" fill="none" role="img" aria-labelledby="descId">
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 123.83775689042844;
      }
    }
        ...
        <defs>
          <linearGradient id="gradient" gradientTransform="rotate(45)" gradientUnits="userSpaceOnUse">
              ...
              <stop offset="0%" stop-color="#141414">
                <animate attributeName="stop-color" values="#141414;#202020;#1b4b25;141414" dur="4s" repeatCount="indefinite"/>
              </stop>,
              <stop offset="50%" stop-color="#202020">
                <animate attributeName="stop-color" values="#202020;#1b4b25;#141414;202020" dur="4s" repeatCount="indefinite"/>
              </stop>,
              <stop offset="100%" stop-color="#1b4b25">
                <animate attributeName="stop-color" values="#1b4b25;#141414;#202020;1b4b25" dur="4s" repeatCount="indefinite"/>
              </stop>
          </linearGradient>
        </defs>
    ...
    <svg data-testid="icon" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
      ...
      <text class="stat  bold" x="219.01" y="12.5" data-testid="commits">573</text>
    </g>
